 ...
 */
package com.zh.xplan.ui.view.pulltorefresh.header;
...
import com.zh.xplan.ui.view.pulltorefresh.util.PtrLocalDisplay;
...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        public void setColors(int[] colors) {
            mColors = colors;
            // if colors are reset, make sure to reset the color index1 as well
            setColorIndex(0);
        }
