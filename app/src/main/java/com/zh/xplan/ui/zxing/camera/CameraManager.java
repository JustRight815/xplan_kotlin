...
package com.zh.xplan.ui.zxing.camera;
...
import com.zh.xplan.ui.zxing.PlanarYUVLuminanceSource;
...
@SuppressLint("NewApi") public final class CameraManager {
	 ...
	 * where to place the scan_barcode. This target helps with alignment as well as
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int topOffset = (screenResolution.y - height) / 2- PixelUtil.dp2px(56,context);
