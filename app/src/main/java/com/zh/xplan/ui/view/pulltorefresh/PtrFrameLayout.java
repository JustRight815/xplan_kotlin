...
import com.zh.xplan.ui.view.pulltorefresh.util.PtrCLog;
/**
...
public class PtrFrameLayout extends ViewGroup {
    private boolean isNeedDelayComplete = true;//刷新完成是否需要暂停显示
    // status enum
    ...
    public void setNeedDelayComplete(boolean isNeedDelayComplete){
        this.isNeedDelayComplete = isNeedDelayComplete;
    }

    public boolean getNeedDelayComplete(){
        return this.isNeedDelayComplete;
    }
    ...
    private void notifyUIRefreshComplete(boolean ignoreHook) {
        ...
        //zh 加载完成后延迟500毫秒再隐藏加载完成
        if(isNeedDelayComplete){
